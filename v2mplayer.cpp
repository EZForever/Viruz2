...
namespace
{
  ...
  void UpdateSampleDelta(sU32 nexttime, sU32 time, sU32 usecs, sU32 td2, sU32* smplrem, sU32* smpldelta)
  {
    sU32 q, r;
    sU8 c;
    q = _udiv64((sU64)(nexttime - time) * usecs, td2, (unsigned int*)&r);
    c = _addcarry_u32(0, *smplrem, r, (unsigned int*)smplrem);
    _addcarry_u32(c, *smpldelta, q, (unsigned int*)smpldelta);
  }
#endif
}
...
#else
    ftsmpls = (sU64)a_fadetime * m_samplerate / m_tpc;
#endif
...
#else
      memset(a_buffer, 0, (size_t)a_len * 2);
#endif
    }
	}
	else
