...
//					printf("Remapping PGM %d to %d\n",pc2->v1,tp);
		...
		if (ch.notes.size() && ch.pgmch.size())
			printf("channel %2d: %4zd notes, %4zd pgmch, %4zd pitchb, %4d ctlch\n",i+1,
