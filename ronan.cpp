// ronan hei\xDFt in wirklichkeit lisa. ich war nur zu faul zum renamen.
...
// these are already intrinsics, no need to reinvent the wheel
#define sFtol(f) ((sInt)roundf((f)))
#define sFPow(a,b) (pow((a),(b)))
#define sFExp(f) (exp((f)))
